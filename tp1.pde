...
void draw() {
  ...
  if (segundos>530) {
    img=loadImage("ending2.png");
    y=700;
  }

  if (segundos>531 && segundos<619) {
  ...
  if (segundos>620 ) {
    img=loadImage("ending3.png");
    y=1400;
  }
  if (segundos>620 && segundos<680) {
  ...
  if (segundos>680) {
    img=loadImage("ending4.png");
    y=2100;
  }
  if (segundos>682 && segundos<726) {
    textSize(40);
